...
List of Awesome Resources built on top of Bitte Protocol

### Verified AI Agents

- [Near Safe Agent](https://github.com/bh2smith/near-safe-agent)
- [CoWSwap AI Agent](https://github.com/bh2smith/near-cow-agent#cowswap-ai-agent)
- [Uniswap AI Agent](https://github.com/bh2smith/near-uniswap-agent)
...
- [Meme.cooking Agent](https://github.com/BitteProtocol/meme.cooking-bitte-agent)
- [Potlock Agent](https://github.com/PotLock/potlock-agent-mintbase)
- [DAO Agent](https://github.com/jaswinder6991/dao-agent-next)
- [Python Code Runner](https://github.com/microchipgnu/bitte-wasmer-agent)
-  [GrowthMate Discovery](https://github.com/lennczar/bitte-agent)
-  [NEAR Staking](https://github.com/INTEARnear/token-agent)
-  [Delta Trade DCA Helper](https://github.com/DeltaBotDev/deltatrade-agent-next)
- [Technical Analysis Agent](https://github.com/SurgeCode/technical-analysis-agent)
- [Near Roast Agent](https://github.com/NEARBuilders/near-roast-agent)

### Other AI Agents
- [Bitte Aave Agent](https://github.com/agentool/bitte-aave-agent#bitte-aave-agent)
- [Bitte Open WETH9 Agent](https://github.com/bh2smith/wraptor-agent#bitte-open-weth9-agent)
- [Dapp Radar Agent](https://github.com/BitteProtocol/dapp-radar-agent)
- [Mintbase Contracts Agents](https://github.com/sainthiago/mintbase-contracts-agent)
- [Reedit Agent](https://github.com/microchipgnu/reddit-bitte-agent)
...
-  [Building a DEX screener Agent in 5 minutes](https://www.youtube.com/watch?v=yxPOm5jY_GI)
...
### Packages
- [near-ca](https://github.com/BitteProtocol/near-ca)
- [near-safe](https://github.com/BitteProtocol/near-safe)
- [make-agent](https://github.com/BitteProtocol/make-agent)
- [@bitte-ai/react](https://github.com/BitteProtocol/react)
- [@bitte-ai/chat](https://github.com/BitteProtocol/chat)
- [@bitte-ai/wallet](https://github.com/BitteProtocol/wallet)
- [@bitte-ai/runtime-sdk](https://www.npmjs.com/package/@bitte-ai/runtime-sdk)
...
### Dapps Using Bitte Tech
 ...
 - [Allstake](https://app.allstake.org/)
 - [Potlock](https://alpha.potlock.org/)
 - [GFXVS](https://www.gfxvs.com/)
 - [Veax](https://app.veax.com/trade)
 - [Onsocial.id](https://onsocial.id/)
 - [Near.social](https://near.social/)
 - [Neko](https://factory.nekotoken.xyz/)
 - [ShardDog](https://shard.dog/)
 - [Learn Near Club](https://learnnear.club/)
 - [Build DAO](https://join.nearbuilders.org/)
 - [Nearweek](https://subscribe.nearweek.com/)
 - [Namesky](https://namesky.app/)
 - [ShitzuApes](https://app.shitzuapes.xyz/)
 - [Blackdragon Mint](https://mint.blackdragon.meme/)
 - [Purge](https://www.absolveme.ai/)
 - [SIN Staking](https://app.survivalisnear.xyz/)
 - [DefiShardz](https://defishards.xyz/marketplace)
 - [Noear Snakegame](https://snake-game.noear.xyz/)
 - [Noear Airdrop](https://airdrop.noear.xyz/)
 - [Noear Burner](https://burn.noear.xyz/)
 - [Cheddar.farm](https://cheddar.farm/)
